...
<p>Yaks are <em class='yellow'>solar-powered.</em> The time they spend
napping in direct sunlight is necessary to regenerate their internal
batteries. Yaks that do not receive sufficient charge may exhibit the
following symptoms: lethargy, irritability, and disdainful glares. Yaks
...
process to maximize your enjoyment of your yak.</p><br/><p>
For more yak maintenance tips, tap to view the website!</p>
</article>
"""
...
class MainHandler(webapp2.RequestHandler):
  ...
  def _insert_paginated_item(self):
    ...
    body = {
        ...
        'menuItems': [{
            'action': 'OPEN_URI',
            'payload': 'http://wiki.yak.net/1050',
        }]
    }
    # self.mirror_service is initialized in util.auth_required.
